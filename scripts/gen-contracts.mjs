// Sinkron kontrak dari monorepo ../buildingvision: tokens.css (design-tokens/tokens.json, token netral/semantik)
// & status-map.ts (contracts/status-map.yaml: bvrooms_booking_customer, bvrooms_payment).
...
const groups = ["bvrooms_booking_customer", "bvrooms_payment"].filter((g) => statusMap[g]);
